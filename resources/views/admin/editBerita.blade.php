...
<body>
    ...
    <div class="edit-berita-container">
        ...
        <form action="{{ route('postEditBerita', $berita->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="berita" name="berita" rows="6" required>{{($berita->berita) }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                @if ($berita->gambar)
                <small class="form-text text-muted">Gambar saat ini: {{ $berita->gambar }}</small>
                <img src="{{ asset($berita->gambar) }}" alt="Gambar Berita" width="300px" height="300px" style="object-fit: cover;">
                @endif
            </div>
