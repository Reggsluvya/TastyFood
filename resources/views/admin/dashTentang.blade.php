...
<body>
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link active" href="{{ route('dashTentang') }}">
    ...
    <div class="content">
        <div class="container mt-5">
            <div class="card shadow">
                <h2 class="card-title text-center mt-3 mb-5">Tentang Kami</h2>
                @if (session('success'))
                        ...
                        @foreach ($tentang as $item)
                            <tr>
                                ...
                                <td class="ms-auto d-flex">
                                    <a href="{{ route('editTentang', $item->id) }}"
                                        class="btn btn-outline-success">Edit</a>
                                    <a href="{{ route('hapusTentang', $item->id) }}"
