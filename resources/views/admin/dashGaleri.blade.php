...
<body>
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link active" href="{{ route('dashGaleri') }}">
    ...
    <div class="content">
        ...
        <div class="container mt-3">
            <div class="card shadow">
                <h2 class="card-title text-center mt-3 mb-4">Daftar Galeri</h2>
                <a href="{{ route('tambahGaleri') }}" class="btn btn-outline-primary d-flex ms-auto mb-2"
                    style="margin-right: 5px">Tambah Galeri</a>
                @if (session('success'))
                        ...
                        @foreach ($galeri as $item)
                            <tr>
                                ...
                                <td><img src="{{ asset($item->gambar) }}" style="object-fit: cover;" width="50px"
                                        height="50px" alt=""></td>
                                <td>
                                    <a href="{{ route('editGaleri', $item->id) }}"
                                        class="btn btn-outline-success">Edit</a>
                                    <a href="{{ route('hapusGaleri', $item->id) }}" class="btn btn-outline-danger"
