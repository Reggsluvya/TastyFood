...
<body>
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link active" href="{{ route('dashberita') }}">
    ...
    <div class="content">
        ...
        <div class="container mt-5">
            <div class="card shadow">
                <h2 class="card-title text-center mt-3">Daftar Berita</h2>
                <a href="{{ route('tambahBerita') }}" class="btn btn-outline-primary d-flex ms-auto mb-3"
                    style="margin-right: 5px">Tambah Berita</a>
                @if (session('success'))
                    ...
                    <tbody class="text-center">
                        @foreach ($berita as $item)
                            <tr>
                                ...
                                <td><img src="{{ asset($item->gambar) }}" width="50px"; height="50px";
                                        style="object-fit: cover" alt=""></td>
                                <td>{{ $item->judul }}</td>
                                <td>{{ $item->berita }}</td>
                                <td class="ms-auto d-flex">
                                    <a href="{{ route('editBerita', $item->id) }}"
                                        class="btn btn-outline-success">Edit</a>
                                    <a href="{{ route('hapusBerita', $item->id) }}" class="btn btn-outline-danger mx-2"
